                  ...
                  <div className="contact-us">
                      <h2 className="footer-headline">Contact Us</h2>
                        <div className="contact-info">
                          <div><a href="mailto:tsgriffith91@gmail.com?Subject=Hello" target="_top" className="contact-names">Taylor <span className="email-text">&nbsp;&nbsp;tsgriffith91@gmail.com</span></a></div>
