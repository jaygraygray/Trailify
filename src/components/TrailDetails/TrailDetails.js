      ...
      console.log(localStorage.getItem('trailStorage'))
        ...
        return (
            <div className="trail-details-contain">
              <h1 className="trail-title">{this.state.trail.name}</h1>
              ...
              <div className="trail-additional-info-contain">
                <div className="trail-distance">
                  ...
                  <h1>{this.state.trailLength > 0 ? this.state.trailLength + " mi" : 'Length not found'}</h1>
                </div>
              ...
              <h3 className="trail-name-h2">{this.state.trail.name ? this.state.trail.name : "not found"}</h3>
              <h4 className="trail-description">{this.state.trailDescription ? this.state.trailDescription : 'None Found'}</h4>
              <h3 className="trail-directions-h2">Directions</h3>
              <h4 className="trail-directions">{this.state.trail.directions ? this.state.trail.directions : 'None Found'}</h4>
